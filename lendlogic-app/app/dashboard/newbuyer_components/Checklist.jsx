        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {toolVisible ? (
            ...
            <>
              <a
                target="_blank"
                className="bg-off-white text-lg font-normal flex items-center justify-center h-16 p-3 border-2 border-purple-accent rounded-full shadow-button hover:bg-purple-accent hover:text-off-white hover:font-semibold"
              ...
              <a
                target="_blank"
                className="flex justify-center items-center h-16 bg-off-white text-lg font-normal p-3 border-2 border-purple-accent rounded-full shadow-button hover:bg-purple-accent hover:text-off-white hover:font-semibold"
              ...
              <a
                target="_blank"
                className="bg-off-white flex items-center justify-center h-16 text-lg font-normal p-3 border-2 border-purple-accent rounded-full shadow-button hover:bg-purple-accent hover:text-off-white hover:font-semibold"
