...
export default function LearningSection() {
  ...
  return (
    ...
    <h2 className="font-extrabold py-7">Getting ready to remortgage</h2>
    <p className="py-2 font-normal">Guide</p>
    
    <button className="w-48 h-16 bg-purple-accent  m-5 rounded-full text-xl text-off-white font-semibold shadow-button">See More</button>
    </div>
